...
/* First created by JCasGen Mon Sep 28 15:29:46 EDT 2015 */
package type;
...
/**
 * Stores the information of the passage. Updated by JCasGen Mon Sep 28 17:16:05 EDT 2015 XML
 * source:
...
public class Passage extends ComponentAnnotation implements Comparable {
  ...
  /**
   * getter for label - gets This stores a gold standard label of this answer. 'True' means that it
   * answers the question; otherwise, it is does not.
   * 
   * @generated
   * @return value of the feature
   */
  ...
  /**
   * setter for label - sets This stores a gold standard label of this answer. 'True' means that it
   * answers the question; otherwise, it is does not.
   * 
   * @generated
   * @param v
  ...
  /**
   * getter for sourceDocId - gets This specifies the source document id to which the passage
   * belongs to.
   * 
   * @generated
   * @return value of the feature
  ...
  public String getSourceDocId() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Passage_Type) jcasType).casFeatCode_sourceDocId);
  }

  /**
   * setter for sourceDocId - sets This specifies the source document id to which the passage
   * belongs to.
   * 
   * @generated
   * @param v
  ...
  public Question getQuestion() {
    ...
    return (Question) (jcasType.ll_cas.ll_getFSForRef(
            jcasType.ll_cas.ll_getRefValue(addr, ((Passage_Type) jcasType).casFeatCode_question)));
  }
  ...
  public void setQuestion(Question v) {
    if (Passage_Type.featOkTst && ((Passage_Type) jcasType).casFeat_question == null)
      jcasType.jcas.throwFeatMissing("question", "type.Passage");
    jcasType.ll_cas.ll_setRefValue(addr, ((Passage_Type) jcasType).casFeatCode_question,
  ...
  public int compareTo(Object compareAnnot) {
    ...
    double compareScore = ((Passage) compareAnnot).getScore();
