...
/**
 * Stores the information about a question. Updated by JCasGen Mon Sep 28 17:16:05 EDT 2015 XML
 * source:
...
public class Question extends ComponentAnnotation implements Comparable{
  ...
  public void setPassages(FSArray v) {
    if (Question_Type.featOkTst && ((Question_Type) jcasType).casFeat_passages == null)
      jcasType.jcas.throwFeatMissing("passages", "type.Question");
    jcasType.ll_cas.ll_setRefValue(addr, ((Question_Type) jcasType).casFeatCode_passages,
  ...
  public Passage getPassages(int i) {
    ...
    jcasType.jcas.checkArrayBounds(
            jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type) jcasType).casFeatCode_passages),
            i);
    return (Passage) (jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(
            jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type) jcasType).casFeatCode_passages),
            i)));
  }
